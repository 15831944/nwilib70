...
void CSpreadSheet::SetAppearanceStyle(long propVal)
{
...
void CSpreadSheet::SetTabEnhancedShape(long propVal)
{
	SetProperty(0x215, VT_I4, propVal);
}

unsigned long CSpreadSheet::GetCellNoteIndicatorColor()
{
	unsigned long result;
...
void CSpreadSheet::SetCellNoteIndicatorColor(unsigned long propVal)
{
...
void CSpreadSheet::SetCellNoteIndicatorShape(long propVal)
{
...
void CSpreadSheet::SetTabStripButtonPolicy(long propVal)
{
...
void CSpreadSheet::SetHighlightHeaders(long propVal)
{
	SetProperty(0x21b, VT_I4, propVal);
}

long CSpreadSheet::GetHighlightStyle()
{
	long result;
...
void CSpreadSheet::SetHighlightStyle(long propVal)
{
	SetProperty(0x21c, VT_I4, propVal);
}

unsigned long CSpreadSheet::GetHighlightAlphaBlendColor()
{
	unsigned long result;
...
void CSpreadSheet::SetHighlightAlphaBlendColor(unsigned long propVal)
{
...
void CSpreadSheet::SetHighlightAlphaBlend(short propVal)
{
...
BOOL CSpreadSheet::SetEnhancedSheetTabColors(long clrNormalUpperStartColor, long clrNormalUpperEndColor, long clrNormalLowerStartColor, long clrNormalLowerEndColor, long clrHoverUpperStartColor, long clrHoverUpperEndColor, long clrHoverLowerStartColor, 
...
BOOL CSpreadSheet::SetEnhancedScrollBarColors(long clrTrackColor, long clrArrowColor, long clrUpperNormalStartColor, long clrUpperNormalEndColor, long clrLowerNormalStartColor, long clrLowerNormalEndColor, long clrUpperPushedStartColor, 
...
BOOL CSpreadSheet::SetEnhancedColumnHeaderColors(long clrSelectedHoverUpperColor, long clrSelectedHoverLowerColor, long clrSelectedUpperColor, long clrSelectedLowerColor, long clrHoverUpperColor, long clrHoverLowerColor, long clrUpperColor, 
...
BOOL CSpreadSheet::SetEnhancedRowHeaderColors(long clrSelectedHoverUpperColor, long clrSelectedHoverLowerColor, long clrSelectedUpperColor, long clrSelectedLowerColor, long clrHoverUpperColor, long clrHoverLowerColor, long clrUpperColor, 
		long clrLowerColor, long clrSelectedBorderColor, long clrBorderColor)
{
	BOOL result;
	static BYTE parms[] =
...
long CSpreadSheet::SaveToBuffer(long* buffLen)
{
	long result;
	static BYTE parms[] =
		VTS_PI4;
	InvokeHelper(0x21d, DISPATCH_METHOD, VT_I4, (void*)&result, parms,
		buffLen);
	return result;
}

void CSpreadSheet::LoadFromBuffer(long Buff, long buffLen)
{
	static BYTE parms[] =
		VTS_I4 VTS_I4;
	InvokeHelper(0x21e, DISPATCH_METHOD, VT_EMPTY, NULL, parms,
		 Buff, buffLen);
}

long CSpreadSheet::SaveBlockToBuffer(long Col, long Row, long Col2, long Row2, long* buffLen, BOOL fSaveColInfo, BOOL fSaveRowInfo)
{
	long result;
	static BYTE parms[] =
		VTS_I4 VTS_I4 VTS_I4 VTS_I4 VTS_PI4 VTS_BOOL VTS_BOOL;
	InvokeHelper(0x21f, DISPATCH_METHOD, VT_I4, (void*)&result, parms,
		Col, Row, Col2, Row2, buffLen, fSaveColInfo, fSaveRowInfo);
	return result;
}

void CSpreadSheet::LoadBlockFromBuffer(long Col, long Row, long Col2, long Row2, long Buff, long buffLen)
{
	static BYTE parms[] =
		VTS_I4 VTS_I4 VTS_I4 VTS_I4 VTS_I4 VTS_I4;
	InvokeHelper(0x220, DISPATCH_METHOD, VT_EMPTY, NULL, parms,
		 Col, Row, Col2, Row2, Buff, buffLen);
}
